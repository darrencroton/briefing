...
- Supported CLI LLM providers are `claude`, `codex`, `copilot`, and `gemini`.
- The supported API LLM provider is `openai-compatible`.
...
briefing validate       # environment + noted preflight diagnostics
